        ...
        series: [
          {
            ...
            data: [
              {value: 32, name: '华庆32%', itemStyle: {color: "#1ed7f4"}},
              {value: 18, name: '姬塬18%', itemStyle: {color: "#007fff"}},
              {value: 16, name: '镇北,安塞,三边16%', itemStyle: {color: "#1fcf98"}},
              {value: 14, name: '其他14%', itemStyle: {color: "#ff6766"}},
              {value: 20, name: '合水20%', itemStyle: {color: "#f5b82c"}}
            ]
          },
          {
            name: "",
